...
class OverlayView(context: Context?, attrs: AttributeSet?) :
    ...
    init {
        //Utilidades.reproducirSonidoNotificacion(context!!)
        initPaints()
    }
    ...
    //Esto dibuja el area de deteccion y hace mediciones
    private fun initPaints() {

        textBackgroundPaint.color = ContextCompat.getColor(context!!,R.color.mp_primary)
        textBackgroundPaint.style = Paint.Style.FILL
        textBackgroundPaint.textSize = 52f
